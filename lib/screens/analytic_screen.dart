  ...
  LineChartData mainData() {
    return LineChartData(
      ...
      lineBarsData: [
        LineChartBarData(
          spots: [
            FlSpot(0, expenseJanuary),
            FlSpot(1, expenseFebruary),
            FlSpot(2, expenseMarch),
            FlSpot(3, expenseApril),
            FlSpot(4, expenseMay),
            FlSpot(5, expenseJune),
            FlSpot(6, expenseJuly),
            FlSpot(7, expenseAugust),
            FlSpot(8, expenseSeptember),
            FlSpot(9, expenseOctober),
            FlSpot(10, expenseNovember),
            FlSpot(11, expenseDecember),
          ],
          isCurved: false,
