...
class _MyWidgetState extends State<SignUpTestScreen> {
  ...
  Future<void> pushDataToBackend({
    ...
    APIService.postData("/api/user", userData);
  }
  ...
  Future signUp() async {
    ...
    try {
      pushDataToBackend(
        email: useremailController.text,
        dateOfBirth: userbirthdateController.text,
        fullName: userfullnameController.text,
      );
      createData();
      ...
      Navigator.push(context,
          MaterialPageRoute(builder: (context) => const SigninTestScreen()));
      Fluttertoast.showToast(
