...
class ListFoodAndBeverageScreen extends StatefulWidget {
  const ListFoodAndBeverageScreen({super.key});

  @override
  State<ListFoodAndBeverageScreen> createState() => _MyWidgetState();
}

class _MyWidgetState extends State<ListFoodAndBeverageScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Food & Beverage Expenses'),
            ...
            children: [
              StreamBuilder<QuerySnapshot>(
                stream: transactiondata
                    ...
                    .where('transaction category', isEqualTo: 'FoodandBeverage')
                    .snapshots(),
