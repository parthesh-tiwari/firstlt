...
class ListShoppingScreen extends StatefulWidget {
  const ListShoppingScreen({super.key});

  @override
  State<ListShoppingScreen> createState() => _ListShoppingScreenState();
}

class _ListShoppingScreenState extends State<ListShoppingScreen> {
            ...
            children: [
              StreamBuilder<QuerySnapshot>(
                stream: transactiondata
                    ...
                    .where('transaction category', isEqualTo: 'Shopping')
                    .snapshots(),
