...
class ListElectronicScreen extends StatefulWidget {
  const ListElectronicScreen({super.key});

  @override
  State<ListElectronicScreen> createState() => _ListElectronicScreenState();
}

class _ListElectronicScreenState extends State<ListElectronicScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Electronic Expenses'),
            ...
            children: [
              StreamBuilder<QuerySnapshot>(
                stream: transactiondata
                    ...
                    .where('transaction category', isEqualTo: 'Electronic')
                    .snapshots(),
