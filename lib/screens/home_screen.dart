...
class _MyWidgetState extends State<HomeScreen> {
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () async {
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => const CombineScreen()));
        },
  ...
  BarTouchData get barTouchData => BarTouchData(
        ...
        touchTooltipData: BarTouchTooltipData(
          ...
          getTooltipItem: (
            ...
            String tooltipText = 'Rs ' + rod.toY.toStringAsFixed(2);
            Color tooltipColor;

            switch (groupIndex) {
              case 0:
                tooltipColor = const Color(0xFF6D5FED);
                break;
              case 1:
                tooltipColor = const Color(0xFFE74852);
                break;
              case 2:
                tooltipColor = const Color(0xFF24A891);
                break;
              default:
                tooltipColor = Colors.cyan;
                break;
            }
  ...
  Widget getTitles(double value, TitleMeta meta) {
    ...
    switch (value.toInt()) {
      case 0:
        text = 'Income';
        textColor = const Color(0xFF9489F5);
        break;
      case 1:
        text = 'Expense';
        textColor = const Color(0xFFFF6D33);
        break;
      case 2:
        text = 'Saving';
        textColor = const Color(0xFF39D2C0);
        break;
      default:
        text = '';
